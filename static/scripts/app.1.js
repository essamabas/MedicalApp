...
angular
  ...
  .config(['$stateProvider','$urlRouterProvider','$ocLazyLoadProvider','AngularBaseUrl','BowerBaseUrl', '$authProvider',
    function($stateProvider, $urlRouterProvider , $ocLazyLoadProvider , AngularBaseUrl , BowerBaseUrl ,  $authProvider) {
